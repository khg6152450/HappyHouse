	...
	<div style="display: block;">
		...
		<div style="background-color: white">
			...
			<div style="text-align: center;">
				<a href="<c:url value="/search"/>">전체 매매 목록</a> &ensp; <a
					href="<c:url value="/isafe"/>">아이지킴이 정보</a> &ensp;
			</div>
			<div>
				<img class="aptImg"
					src="${pageContext.request.contextPath}/resources/img/${apt.aptName}.jpg" />
			</div>
			<div>
				<div class="container">
		...
		<script
			src="https://unpkg.com/@google/markerclustererplus@4.0.1/dist/markerclustererplus.min.js"></script>
		<script async defer
			src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC7Se1og4I5GE7YoL0cvD96gQCZQXPZJR0&callback=initMap"></script>
