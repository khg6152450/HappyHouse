		...
		<div style="background-color: white">
			...
			<div>
				...
				<div class="container" style="text-align: center; padding: 20px;">
					...
					&emsp;&emsp;
					<h2 onclick="compareOn()" style="display: inline;">가격 비교</h2>					
				</div>
				<div class="container">
				...
				<div class="container">
					...
					<table class="table mt-4">
						...
						<c:if test="${user != null}">
							<tr>
								<th style="width: 25%; text-align: center;">사용자 설정 금액</td>
							...
							<tr>
								...
								<th class="test" style="display: none; width: auto;"></th>
								<td style="width: 25%; text-align: center;">${user.buildYear}</th>
								<td style="width: 25%; text-align: center;">${user.area}</th>
								<th class="test" style="display: none; width: auto;"></th>
							</tr>
							<hr>
						</c:if>
